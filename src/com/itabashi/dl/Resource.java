...
public class Resource {
	...
	public static void set(String path, Object data, CustomConfig configuration) {
		configuration.getConfiguration().set(configuration.getSectionName() + "." + path, data);
		configuration.saveConfiguration();
	}

	public static Object get(String path, CustomConfig configuration) {
		return configuration.getConfiguration().get(configuration.getSectionName() + "." + path);
	}

	public static Object get(String path, CustomConfig configuration, Object defaultObject) {
	...
	public static ConfigurationSection getConfigurationSection(String path, CustomConfig configuration) {
